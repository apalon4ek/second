...
'keyboard'=>[
[['text'=>"🖇Referal🖇"],['text'=>"💰Kabinet👤"]],
[['text'=>"⭐ADMIN⭐"],['text'=>"🇺🇸Nomer Olish🇺🇸"]],[['text'=>"📊STATISTIKA📊"]]]
]);



$balinfo = "Salom🖐 Bu bot orqali siz AMERICA (USA) 🇺🇸Nomer olib telegram akkount ochishingiz mumkin.\n\n
...
if($tx=="📊STATISTIKA📊"){
    ...
    bot('sendmessage',[
        'chat_id'=>$cid,
        'text'=>"Botimiz azolari $ab ta \n\n Jami berilgan nomer uchun BALL: $sum ball"
...
$ss=substr($ex[1],8,8);
  file_put_contents("$cid.t","🔵 Status - ✅ \n\n 🆔 Tolov id: $t \n\n 👤 Qabul qiluvchini raqami: \n\n ☎️$bb $gg $ss \n\n 💰 usa soni: $ex[2] ta");
    bot('sendmessage',[
        'chat_id'=>$cid,
        'text'=>"Yaxshi $ex[1] Nomerga $ex[2] ball 24 soat davomida amalga oshiriladi buni @kanaluz_useri Kanalida Ko'ring, Agar Amalga Oshirilmasa Admin Bilan Bog'laning!!"
        ]);
        
        bot('sendmessage',[
            'chat_id'=>$admin,
            'text'=>"*usa yechish uchun yangi zayavka tushdi * \n` zayavkachi haqida ma'lumot\n id raqami $cid\n username: @$user \n Ismi: `[$name](tg://user?id=$cid) \n *Tushuriladigon usa miqdori:$ex[2] sum  \n Raqami: $ex[1] \n\n USA tolandimi tolangan bolsa tolandi=$cid shunday deb yozing!!* ",
...
if($tx=="⭐ADMIN⭐"){
    bot('sendmessage',[
        'chat_id'=>$cid,
        'text'=>"🤓 Bot Admini: @Online_Wolf\n\n
⏳ Ish Vaqti: 07:00 - 21:00\n\n
Reklama Berish Uchun @Uzbcoder_n1 Bilan Bog'laning"
...
'text'=>"Hammaga habar yetkazildi",
    ...
    $okcha = "kanalga azo boldingiz va 1ga ega boldingiz 3 kun ichida chiqib ketsangiz 20 Ball shtraf.";
